...
class Teacher extends Person {
    ...
    render(options, {item}) {
        return `<div class="persons__item">
            ...
            <p class="persons__university" title="${item.university} преподаватель">${item.university} преподаватель</p>
        </div>`;
    }
    ...
    onClick(event) {
        ...
        this.popup.clear('teacher')
        this.popup.open('teacher', {
            content: `
            <div class="card">
            <span class="close"></span>
                ...
                <div class="card__info">
                    ...
                    <div class="card__text">
                        ...
                        <div class="card__text__item">
                            <span class="card__text--grey card__text--left card__status">Работает</span>
